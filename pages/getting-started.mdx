...
- Gravity account [(Create one)](https://app.gravity-testing.com/register)
- A web application
...
- Get the key for your production environment. Its role is to let Gravity knows that the data should be stored as  **User** sessions.
...
<Alert type={AlertType.info} title="Why two keys?">
  Gravity helps you decide what end-to-end tests should be integrated in your test suite. In that purpose, it compares what your users actually do against what you test.
...
<Alert type={AlertType.info}>
  ...
  Check it out here: [Github - gravity-data-collector](https://github.com/Smartesting/gravity-data-collector)
</Alert>
