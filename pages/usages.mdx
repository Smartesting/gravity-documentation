...
import imUntestedUsage from '../public/img/usages/untested-usage.png'
import imgNoUntestedUsageMessage from '../public/img/usages/no-untested-usage-message.png'
...
<Image src={imUntestedUsage} alt="Untested scope"/>

If all your usages are covered by at least one test in the scope, you get the following message:

<Image src={imgNoUntestedUsageMessage} alt="No untested usage in scope"/>
